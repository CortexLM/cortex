...
(100% prism; sum `10000`). Rebalance via the owner trust-root ceremony
...
[`../20-pre-prod-local.md`](../20-pre-prod-local.md)).
...
- Miner guide: [`external-miner/`](./external-miner/README.md)
- Emission ceremony: [`config/CEREMONY.md`](../../config/CEREMONY.md)
- Prism (sibling challenge): [`PRISM.md`](./PRISM.md)
- Architecture map: [`../../README.md`](../../README.md) § Architecture
