...
case "$SERVICE" in validator|gateway|updater|relearn-challenge|relearn-t2i-challenge|relearn-agent-challenge|bounty-challenge) ;; *) die "service must be validator|gateway|updater|relearn-challenge|relearn-t2i-challenge|relearn-agent-challenge|bounty-challenge" ;; esac
