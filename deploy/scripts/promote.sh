...
case "$SERVICE" in validator|gateway|updater|relearn-challenge|bounty-challenge) ;; *) die "service must be validator|gateway|updater|relearn-challenge|bounty-challenge" ;; esac
