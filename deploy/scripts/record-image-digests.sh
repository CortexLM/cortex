...
#
# Default images: validator:0.1.0 gateway:0.1.0 updater:0.1.0 relearn-challenge:0.1.0
# Writes JSON:
...
if [[ ${#IMAGES[@]} -eq 0 ]]; then
  IMAGES=(validator:0.1.0 gateway:0.1.0 updater:0.1.0 relearn-challenge:0.1.0)
fi
