...
need "$SUMMARIZE" 'MAX_TRIAL_LOG_CHARS = 8 * 1024'
need "$SUMMARIZE" 'MAX_TRIAL_LOG_CHARS_STEP_2K = 2 * 1024'
need "$SUMMARIZE" 'def fit_results_under_cap'
need "$SUMMARIZE" 'def dumps_results'
