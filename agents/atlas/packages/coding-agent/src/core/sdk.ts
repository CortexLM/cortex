...
export interface CreateAgentSessionOptions extends AgentSessionCreationOptions {
	...
	/** Replace built-ins entirely for embedders that own their execution boundary. */
	baseToolsOverride?: Record<string, AgentTool>;
	/** Disable controller-local memory and command interpretation for untrusted embedded sessions. */
...
export async function createAgentSession(options: CreateAgentSessionOptions = {}): Promise<CreateAgentSessionResult> {
	...
	const session = new AgentSession({
		...
		includeHarnessState: options.includeHarnessState,
		allowSessionCommands: options.allowSessionCommands,
		modelRegistry,
		mcpManager,
